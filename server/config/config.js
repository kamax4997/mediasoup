...
module.exports =
{
	...
	auth :
	{
		...
		oidc:
		{
			...
			clientOptions :
			{
				client_id     : '319287154772-itmjrboeqsv840mbf6m0m7st0b7lvqls.apps.googleusercontent.com',
				client_secret : 'nVdiPOzQhVWPDS6vq8SdfLSa',
				scope       		: 'openid email profile',
				// where client.example.com is your multiparty meeting server
				redirect_uri  : 'https://guruquest.gq/auth/callback'
			}
	...
	*/
	...
	cookieName   : 'wearhouse.sid',
	// if you use encrypted private key the set the passphrase
	tls          :
	{
		cert : `/opt/audiotest/server/guruquest.gq.crt`,
		// passphrase: 'key_password'
		key  : `/opt/audiotest/server/guruquest.gq.key`
	},
	...
	/*
	userMapping : async ({ peer, roomId, userinfo, makeAdmin }) =>
	{
	...
	*/
	...
	userMapping           : async ({ peer, roomId, userinfo, makeAdmin }) =>
	{
		...
		if (userinfo.email == 'varundabke@gmail.com' || userinfo.email == 'rajesh.yesplus@gmail.com')
		{
			peer.addRole(userRoles.MODERATOR);
		}
		console.log("roles added");
	...
	permissionsFromRoles : {
		...
		[EXTRA_VIDEO]      : [ userRoles.MODERATOR ],
	...
	mediasoup            :
	{
		...
		webRtcTransport :
		{
			...
			[
				...
				{ ip: '78.47.146.251', announcedIp: null }
